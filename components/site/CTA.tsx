...
export function CTA({ label = "Quero implantar o Shamar PDV", source = "cta" }: { label?: string; source?: string }) {
  const eventName = label === "Agendar demonstracao" ? "agendar_demo" : label === "Falar com vendas" ? "falar_com_vendas" : label === "Pedir proposta" ? "pedir_proposta" : "quero_implantar";
  return (
    <div className="ctaPanel">
      <p className="eyebrow">Pronto para ver na pratica?</p>
      <h2>Comece pelo caminho seguro: demonstracao, proposta ou piloto assistido.</h2>
